...
<head>
  ...
  <body>
     <section class="wrap">
        ...
        <div>
            <button class="btn btn1" onclick="window.location.href='index_ko.html'">Korean</button>
            <button class="btn btn2" onclick="window.location.href='index_eng.html'">English</button>
